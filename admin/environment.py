...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'openimages_dir': empty_str,
        'kpn_testset_path': empty_str,
        'bpn_color_testset_dir': empty_str
    })
    ...
    comment = {'workspace_dir': 'Base directory for saving network checkpoints.',
               ...
               'openimages_dir': 'OpenImage path',
               'kpn_testset_path': 'KPN Grayscale denoising test set path',
               'bpn_color_testset_dir': 'BPN Color denoising test set path'}
